...
import ImportImagePreview from './components/ImportImagePreview';
          ...
          <SafeAreaView style={styles.container} >
            <StatusBar backgroundColor="#17B169" style="light" />
              <Stack.Navigator>
                ...
                <Stack.Screen name="ImportImagePreview" component={ImportImagePreview} options={{headerShown: false}}/>
              </Stack.Navigator>
          </SafeAreaView>
        </NavigationContainer>
  );
